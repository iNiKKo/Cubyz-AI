...
# Same two prompts as client_finetune_linux.py -- see that file for the reasoning behind why
# docs/codebase get a "restyle already-validated content" prompt while reviews get a stricter,
# judgment-focused prompt with a debugging-vs-review shape choice.
...
def choose_model() -> tuple:
    ...
    if has_apple_gpu:
        ...
        vram = dgpu_vram if has_dgpu else 0.0
...
def main():
    print("=== Cubyz Fine-Tune Dataset Generation Node (Mac Edition) ===")
