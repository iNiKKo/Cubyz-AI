# [easy/codebase_assets_cubyz_biomes_cave_mantle_lava_pool.zig.zon] - Chunk 0

**Type:** configuration
**Keywords:** chance, caves, soilCreep, ground_structure, structures
**Concepts:** world generation, biome configuration

## Summary
Defines configuration for a cave mantle lava pool biome.

## Explanation
This chunk defines the configuration settings for a cave mantle lava pool biome within the Cubyz voxel engine. The specific probabilities and structures include:
- Chance of occurrence: 0.3
- Cave depth adjustment: -0.03
- Soil creep behavior: 1
- Ground structure compositions: 2 to 3 cubyz:lava, 1 to 2 cubyz:magma
- Additional structures like ground patches with specific block types and dimensions:
