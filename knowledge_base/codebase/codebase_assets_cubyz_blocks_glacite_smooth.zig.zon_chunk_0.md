# [easy/codebase_assets_cubyz_blocks_glacite_smooth.zig.zon] - Chunk 0

**Type:** configuration
**Keywords:** block configuration, ore generation, rotation model, cube shape, texture
**Concepts:** block properties, texture mapping

## Summary
Defines properties for the smooth glacite block in Cubyz.

## Explanation
This chunk defines configuration settings for a specific block type, 'smooth glacite', within the Cubyz game engine. The configuration is as follows:
