...
## Summary
Defines blueprints for medium-sized mahogany trees. Each blueprint is identified by a unique ID.

## Explanation
This chunk contains a configuration structure defining two blueprints for medium-sized mahogany trees. Each blueprint has an unique identifier used to reference the specific tree variant within the game's asset system. The IDs of these blueprints are: `cubyz:tree/mahogany/khaya_ivorensis/medium/1` and `cubyz:tree/mahogany/khaya_ivorensis/medium/2`. These identifiers are used to reference the specific tree variants within the game's asset system.
