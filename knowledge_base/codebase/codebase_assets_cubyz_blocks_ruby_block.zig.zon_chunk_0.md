...
- How much health does the Ruby Block have?
- What is the resistance value of the Ruby Block?
- Does the Ruby Block drop items when mined?
- What type of rotation model does the Ruby Block use?
- Which texture is assigned to the Ruby Block?

*Source: unknown | chunk_id: codebase_assets_cubyz_blocks_ruby_block.zig.zon_chunk_0*
