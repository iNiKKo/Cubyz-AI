...
## Summary
This discussion focuses on various material modifiers for tools in Cubyz, including both common and rare modifiers. The maintainers propose adding new modifiers such as 'non-newtonian', 'life steal', and 'energy steal' while considering the balance of gameplay. The entry should include detailed descriptions of all proposed modifiers and their mechanics to ensure accurate understanding.

## Explanation
The discussion revolves around various material modifiers for tools in Cubyz, including common and rare modifiers, their effects, and potential implementations. Maintainers suggest adding new modifiers like 'non-newtonian', 'life steal', and 'energy steal' while considering the balance of gameplay. The entry should include detailed descriptions of all proposed modifiers and their mechanics to ensure accurate understanding.
