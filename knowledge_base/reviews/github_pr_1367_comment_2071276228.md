...
- `isBlockTexture`: A boolean indicating whether the particle is associated with a block texture.
- `animationFrames`: An integer specifying the number of animation frames for the particle.
