...
## Explanation
The proposal aims to standardize addon metadata by introducing an `addon.zig.zon` file to simplify addon discovery and management within Cubyz. The proposed metadata file would include the following specific keys:
- Author names
- Maintainer names
- Web page link
- GitHub link
...
- Name (human-readable)
- Short description
- Supported Cubyz versions
- Addon version (+ changelogs?)
- Metadata version
...
- What specific keys should be included in the `addon.zig.zon` file (e.g., author names, maintainer names, web page link)?
