# [issues/issue_2969.md] - Issue #2969 discussion

**Type:** review
**Keywords:** Sulfur Caves, terrain features, gameplay features, useless material, content guidelines, reference implementation
**Concepts:** content guidelines, biome design
...
- How do the gameplay features in Sulfur Caves differ from other biomes?
- Why did the maintainer consider the sulfur material 'useless'?
- What specific content guideline was violated by the proposal?
- How does Cubyz handle proposals that violate content guidelines?
- Are there any plans to implement the Sulfur Caves biome in a different form?

*Source: unknown | chunk_id: github_issue_2969_discussion*
