...
## Explanation
The discussion revolves around adding a skeleton system to support inverse kinematics and other animations in Cubyz. The proposal includes defining joints and bones either through a separate file format (.zon) or by extending existing formats like OBJ. There's also mention of potential future adoption of the GLTF format, which supports binary representation and animations, suggesting that this issue might be addressed when transitioning to GLTF.
