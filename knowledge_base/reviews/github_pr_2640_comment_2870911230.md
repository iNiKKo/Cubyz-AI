...
The `Category` enum includes the following values: block, item, label, language, modifier, tag, tool, and world_preset. Each category corresponds to a specific section in the ZonElement for translation purposes.
