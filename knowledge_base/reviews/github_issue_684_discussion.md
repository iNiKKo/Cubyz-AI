# [issues/issue_684.md] - Issue #684 discussion

**Type:** review
**Keywords:** terrain generation presets, tweak settings, world creation, issue hijacking, feature enhancement
...
- How can users currently customize terrain generation during world creation?
- Is there a plan to implement this feature in future releases?
- Are there any existing issues related to terrain generation customization?
- Who is responsible for implementing this feature enhancement?
- What are the potential benefits of allowing users to tweak all terrain generator settings?

*Source: unknown | chunk_id: github_issue_684_discussion*
