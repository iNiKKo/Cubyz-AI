...
The `applyDeadzone` function takes an input value and adjusts it based on the specified deadzone. If the absolute value of the input is less than the deadzone, it returns 0; otherwise, it scales the input to fit within the range defined by the deadzone and 1.0.
