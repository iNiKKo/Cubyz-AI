# [issues/issue_560.md] - Issue #560 discussion

**Type:** review
**Keywords:** bug, feature, jumping, block, gap
**Concepts:** gameplay mechanics, user experience
...
- How does this behavior affect gameplay mechanics?
- Are there any potential user experience issues related to this feature/bug?
- Should this behavior be fixed or left as is?
- Is there a way to toggle this behavior for different game modes?
- What are the implications of changing this behavior on existing levels and maps?

*Source: unknown | chunk_id: github_issue_560_discussion*
