...
## Explanation
The user encountered an issue where the dead zone bar was stuck at 500%, preventing them from adjusting the cursor sensitivity. The maintainer suggested unplugging the controller and rebooting the game as a temporary workaround. Additionally, there are reports of inconsistent gamepad sensitivity, with one stick being too sensitive and the other not sensitive enough. This indicates potential bugs in the game's input handling for controllers.
