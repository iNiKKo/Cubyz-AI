# [medium/docs_CONTRIBUTING.md] - Chunk 1

**Type:** documentation
**Keywords:** Cubyz, PR, CI, review process, help seeking, discord server, work-life balance
**Concepts:** contributing guidelines, pull request review, continuous integration, self-care

## Summary
The document outlines guidelines for contributing to the Cubyz project, including checking changes after pull requests, participating in the review process, seeking help when stuck, and taking care of oneself.
...
- Where can contributors seek help when they encounter difficult issues?
- Why is self-care emphasized in the Cubyz project's contribution guidelines?
- What is the primary goal of maintaining high standards in the Cubyz project?
- How does the document describe the relationship between quality and personal well-being in contributing to Cubyz?

*Source: unknown | chunk_id: docs_CONTRIBUTING.md_chunk_1*
