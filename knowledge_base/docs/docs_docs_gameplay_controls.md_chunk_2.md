# [easy/docs_docs_gameplay_controls.md] - Chunk 2

**Type:** gameplay
**Keywords:** utilities, screenshot, fullscreen, escape, inventory, creative inventory, chat, command
**Symbols:** Print Screen, F11, Escape, E, C, T, /
...
- What key closes/backs out of a menu or dialog in Cubyz?
- What key opens the regular (non-creative) inventory in Cubyz?
- How do you access the creative inventory in Cubyz?
- How do you open chat in Cubyz?
- What key or character opens the command line in Cubyz?

*Source: unknown | chunk_id: docs_docs_gameplay_controls.md_chunk_2*
