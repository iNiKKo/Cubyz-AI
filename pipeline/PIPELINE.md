...
```
pipeline/organized_cubyz_dataset/{easy|medium|hard}/
```
...
1. Start (or restart) `pipeline/server.py`. It scans `organized_cubyz_dataset/`
...
2. Restart pipeline/server.py -> auto-scans, auto-chunks, queues new work
