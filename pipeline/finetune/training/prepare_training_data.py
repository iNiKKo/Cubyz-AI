...
# Anchor paths to pipeline/ (three levels up from this file: training/ -> finetune/ -> pipeline/)
# rather than the process's cwd -- these scripts get run from both the repo root and from inside
...
CUBYZ_DATASET = os.path.join(PIPELINE_ROOT, "finetune/output/cubyz_sft_dataset.jsonl")
OUTPUT_DIR = os.path.join(PIPELINE_ROOT, "finetune/training/data")
