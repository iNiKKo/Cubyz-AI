...
PAIRS_DIR = "pipeline/finetune/pairs"  # server_finetune.py's own managed output -- wiped on hard reset
HANDWRITTEN_DIR = "pipeline/finetune/handwritten_pairs"  # never touched by the campaign's reset logic
OUTPUT_FILE = "pipeline/finetune/output/cubyz_sft_dataset.jsonl"
